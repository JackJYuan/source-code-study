...
public class HandlerMethod {
	...
	/**
	 * beanFactory主要用于新建HandlerMethod时传入的Handler(也就是bean属性)是String的情况，这时需要使用beanFactory根据传入的String左为beanName获取到对应的bean，
	 * 并设置为Handler
	 * */
	@Nullable
	...
	/**
	 * bridgedMethod指如果method是bridge method则设置为其对应的原有方法，否则直接设置为method
	 * */
	private final Method bridgedMethod;

	/**
	 * parameters代表处理请求的方法的参数
	 * */
	 ...
	 *
	 * 当提供的Handler为String，即beanName，而不是一个真正的bean时，从beanFactory获取beanName对应的bean
	 *
	 */
